                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/backend/product_details.php?product_id=101" class="btn btn-info">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/backend/product_details.php?product_id=201" class="btn btn-info">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
